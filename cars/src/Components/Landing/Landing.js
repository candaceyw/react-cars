...
function Landing({ cars, setCars }) {
    ...
    return (
        <div className="car-section">
            <div className="nav">
            <form onSubmit={(e) => submitHandler(e)} className="search-form">
            <input onChange={(e) => setInput(e.target.value)} name="search" placeholder="Enter A Model or Make" className="search-bar"/>
